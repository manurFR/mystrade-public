...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TradedCommodities.commodityinhand'
        db.add_column('trade_tradedcommodities', 'commodityinhand',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TradedCommodities.commodityinhand'
        db.delete_column('trade_tradedcommodities', 'commodityinhand')

        # Renaming column for 'TradedCommodities.commodity' to match new field type.
        db.rename_column('trade_tradedcommodities', 'commodity', 'commodity_id')
        # Changing field 'TradedCommodities.commodity'
        db.alter_column('trade_tradedcommodities', 'commodity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.CommodityInHand']))
        # Adding index on 'TradedCommodities', fields ['commodity']
        db.create_index('trade_tradedcommodities', ['commodity_id'])
    ...
    models = {
        ...
        'trade.tradedcommodities': {
            ...
            'commodityinhand': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
