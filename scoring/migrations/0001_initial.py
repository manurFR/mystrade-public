...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'scoring_scorefromrule', (
        ...
        db.send_create_signal(u'scoring', ['ScoreFromRule'])

        # Adding model 'ScoreFromCommodity'
        db.create_table(u'scoring_scorefromcommodity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Game'])),
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.MystradeUser'])),
            ('commodity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ruleset.Commodity'])),
            ('nb_submitted_cards', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ...
        db.send_create_signal(u'scoring', ['ScoreFromCommodity'])


    def backwards(self, orm):
        # Deleting model 'ScoreFromRule'
        db.delete_table(u'scoring_scorefromrule')

        # Deleting model 'ScoreFromCommodity'
        db.delete_table(u'scoring_scorefromcommodity')
