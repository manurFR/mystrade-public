...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GamePlayer.last_seen'
        db.add_column(u'game_gameplayer', 'last_seen',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GamePlayer.last_seen'
        db.delete_column(u'game_gameplayer', 'last_seen')
