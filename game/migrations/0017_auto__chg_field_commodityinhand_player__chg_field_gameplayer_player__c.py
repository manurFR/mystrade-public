...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CommodityInHand.player'
        db.alter_column(u'game_commodityinhand', 'player_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[settings.AUTH_USER_MODEL]))

        # Changing field 'GamePlayer.player'
        db.alter_column(u'game_gameplayer', 'player_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[settings.AUTH_USER_MODEL]))

        # Changing field 'Game.master'
        db.alter_column(u'game_game', 'master_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[settings.AUTH_USER_MODEL]))

        # Changing field 'Message.sender'
        db.alter_column(u'game_message', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[settings.AUTH_USER_MODEL]))

        # Changing field 'RuleInHand.player'
        db.alter_column(u'game_ruleinhand', 'player_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[settings.AUTH_USER_MODEL]))
    ...
    models = {
        ...
        u'game.commodityinhand': {
            ...
            'player': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['" + settings.AUTH_USER_MODEL + "']"})
        },
        u'game.game': {
            ...
            'players': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'playing_games_set'", 'symmetrical': 'False', 'through': u"orm['game.GamePlayer']", 'to': u"orm['" + settings.AUTH_USER_MODEL + "']"}),
        ...
        u'game.message': {
            ...
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['" + settings.AUTH_USER_MODEL + "']"})
        },
        u'game.ruleinhand': {
