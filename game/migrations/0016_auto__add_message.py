...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('game_message', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Game'])),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[settings.AUTH_USER_MODEL])),
        ...
        db.send_create_signal('game', ['Message'])


    def backwards(self, orm):
        # Deleting model 'Message'
        db.delete_table('game_message')
    ...
    models = {
        ...
        'game.message': {
            ...
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['" + settings.AUTH_USER_MODEL + "']"})
        },
        'game.ruleinhand': {
