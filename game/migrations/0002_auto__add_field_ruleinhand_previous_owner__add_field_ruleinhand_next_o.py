...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RuleInHand.previous_owner'
        db.add_column(u'game_ruleinhand', 'previous_owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['profile.MystradeUser']),
                      keep_default=False)

        # Adding field 'RuleInHand.next_owner'
        db.add_column(u'game_ruleinhand', 'next_owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['profile.MystradeUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RuleInHand.previous_owner'
        db.delete_column(u'game_ruleinhand', 'previous_owner_id')

        # Deleting field 'RuleInHand.next_owner'
        db.delete_column(u'game_ruleinhand', 'next_owner_id')
