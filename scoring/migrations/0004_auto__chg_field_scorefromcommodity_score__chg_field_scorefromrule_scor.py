...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScoreFromCommodity.score'
        db.alter_column('scoring_scorefromcommodity', 'score', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ScoreFromRule.score'
        db.alter_column('scoring_scorefromrule', 'score', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ScoreFromCommodity.score'
        db.alter_column('scoring_scorefromcommodity', 'score', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'ScoreFromRule.score'
        db.alter_column('scoring_scorefromrule', 'score', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
