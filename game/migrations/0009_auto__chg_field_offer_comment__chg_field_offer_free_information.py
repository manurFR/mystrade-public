...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        for offer in Offer.objects.filter(comment = ''):
            offer.comment = None
            offer.save()
        ...
        for offer in Offer.objects.filter(free_information = ''):
            offer.free_information = None
            offer.save()

    def backwards(self, orm):

        for offer in Offer.objects.filter(comment__isnull = True):
            offer.comment = ''
            offer.save()
        ...
        for offer in Offer.objects.filter(free_information__isnull = True):
