...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScoreFromRule.detail'
        db.alter_column(u'scoring_scorefromrule', 'detail', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'ScoreFromRule.detail'
        db.alter_column(u'scoring_scorefromrule', 'detail', self.gf('django.db.models.fields.CharField')(max_length=255))
