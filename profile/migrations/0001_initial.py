...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'profile_mystradeuser', (
        ...
        db.send_create_signal(u'profile', ['MystradeUser'])

        # Adding M2M table for field groups on 'MystradeUser'
        db.create_table(u'profile_mystradeuser_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mystradeuser', models.ForeignKey(orm[u'profile.mystradeuser'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(u'profile_mystradeuser_groups', ['mystradeuser_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'MystradeUser'
        db.create_table(u'profile_mystradeuser_user_permissions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mystradeuser', models.ForeignKey(orm[u'profile.mystradeuser'], null=False)),
            ('permission', models.ForeignKey(orm[u'auth.permission'], null=False))
        ))
        db.create_unique(u'profile_mystradeuser_user_permissions', ['mystradeuser_id', 'permission_id'])


    def backwards(self, orm):
        # Deleting model 'MystradeUser'
        db.delete_table(u'profile_mystradeuser')

        # Removing M2M table for field groups on 'MystradeUser'
        db.delete_table('profile_mystradeuser_groups')

        # Removing M2M table for field user_permissions on 'MystradeUser'
        db.delete_table('profile_mystradeuser_user_permissions')
