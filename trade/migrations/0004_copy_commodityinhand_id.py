...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for cih in orm['trade.TradedCommodities'].objects.all():
            cih.commodityinhand = cih.commodity.id
            cih.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        cursor = connection.cursor()
        cursor.execute("UPDATE trade_tradedcommodities SET commodity = commodityinhand")
