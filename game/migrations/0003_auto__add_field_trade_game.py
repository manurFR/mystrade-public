...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trade.game'
        db.add_column('game_trade', 'game',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['game.Game']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trade.game'
        db.delete_column('game_trade', 'game_id')
    ...
    models = {
        ...
        'game.game': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 25, 0, 0)'}),
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 25, 0, 0)'})
        },
        'game.ruleinhand': {
