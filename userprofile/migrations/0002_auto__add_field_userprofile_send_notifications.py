...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.send_notifications'
        db.add_column('userprofile_userprofile', 'send_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.send_notifications'
        db.delete_column('userprofile_userprofile', 'send_notifications')
