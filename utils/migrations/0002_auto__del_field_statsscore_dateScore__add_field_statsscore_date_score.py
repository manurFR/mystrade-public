...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StatsScore.date_score'
        db.add_column(u'utils_statsscore', 'date_score',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        for stats in orm['utils.statsscore'].objects.all():
            stats.date_score = stats.dateScore
            stats.save()

        # Deleting field 'StatsScore.dateScore'
        db.delete_column(u'utils_statsscore', 'dateScore')

    def backwards(self, orm):
        # Adding field 'StatsScore.dateScore'
        db.add_column(u'utils_statsscore', 'dateScore',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        for stats in orm['utils.statsscore'].objects.all():
            stats.dateScore = stats.date_score
            stats.save()

        # Deleting field 'StatsScore.date_score'
        db.delete_column(u'utils_statsscore', 'date_score')
    ...
    models = {
        ...
        u'utils.statsscore': {
            ...
            'trade': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['trade.Trade']", 'null': 'True'})
        }
    }
