...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ScoreFromRule.score'
        db.alter_column('scoring_scorefromrule', 'score', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
    ...
    models = {
        ...
        'scoring.scorefromrule': {
            ...
            'score': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'})
        }
    }
