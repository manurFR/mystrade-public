...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'trade_trade', (
            ...
            ('initiator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='initiator_trades_set', to=orm['profile.MystradeUser'])),
            ('responder', self.gf('django.db.models.fields.related.ForeignKey')(related_name='responder_trades_set', to=orm['profile.MystradeUser'])),
            ...
            ('finalizer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.MystradeUser'], null=True)),
        ...
        # Adding model 'Offer'
        db.create_table(u'trade_offer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('free_information', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'trade', ['Offer'])

        # Adding M2M table for field rules on 'Offer'
        db.create_table(u'trade_offer_rules', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('offer', models.ForeignKey(orm[u'trade.offer'], null=False)),
            ('ruleinhand', models.ForeignKey(orm[u'game.ruleinhand'], null=False))
        ))
        db.create_unique(u'trade_offer_rules', ['offer_id', 'ruleinhand_id'])

        # Adding model 'TradedCommodities'
        db.create_table(u'trade_tradedcommodities', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('offer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trade.Offer'])),
            ('commodityinhand', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.CommodityInHand'])),
            ('nb_traded_cards', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
        ))
        db.send_create_signal(u'trade', ['TradedCommodities'])
